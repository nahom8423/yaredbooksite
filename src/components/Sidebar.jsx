...
export default function Sidebar({ isMobile, isWelcome = false, onClose, onNewChat, chatHistory, onChatSelect, currentChatId, onChatDelete, onChatRename, newChatCreated, onAnalyticsOpen }) {
