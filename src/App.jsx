        ...
        <div className="flex-1 bg-[#1A0F08] text-white flex flex-col h-full relative">
                    ...
                    <div className="flex flex-wrap justify-center gap-3 max-w-2xl mx-auto">
                      {yaredBotAPI.getSuggestedQuestions().map((suggestion, index) => (
                        <button
                          ...
                          className="px-4 py-2 text-sm rounded-full border border-[#2F1B12] bg-[#261510] hover:bg-[#2F1B12] hover:border-gray-500 cursor-pointer transition-all text-gray-300 hover:text-white"
                        >
                          {suggestion}
                        </button>
                      ))}
          ...
          {showScrollToBottom && (
            <button
              ...
              className="absolute left-1/2 transform -translate-x-1/2 w-10 h-10 bg-[#2F1B12] hover:bg-[#3D251A] rounded-full flex items-center justify-center shadow-lg border border-[#3D251A] transition-all z-10"
              style={{ 
